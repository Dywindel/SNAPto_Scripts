...
public class Sc_Camera_V4 : MonoBehaviour
{
    ////////////////////////////////////////////////////
    //
	...
	*/
    ...
    [HideInInspector]
    private float angle_Viewing_Offset = 60;
	...
	void LateUpdate ()
	{
        ...
        if (!freeCam)
        {
            ...
            transform.position = lookAtMe.transform.position + rightStick_Offset;
    ...
    void Update()
    {
        ...
        rightStick_Offset = new Vector3(radius*Mathf.Sin((angle_Fez_Rotation) * Mathf.PI / 180),
                                        radius*Mathf.Sin(angle_Offset * Mathf.PI / 180),
                                        -radius*Mathf.Cos((angle_Fez_Rotation) * Mathf.PI / 180));
